...
#TransDB postgreSQL
psql -h 10.0.11.5 -p 7766 -d paygate_system_db -U pti_paygate_prod << EOF > /home/ubuntu/paybiz-v3-monthly/GR_REPORTV3-${filename}.txt
...
from (
    ...
    from receive_otp
    where created_at between (NOW() - INTERVAL '1 MONTH')  and NOW() and merchant_id = '00000027011198B17BFB'
    group by trx_status
    union
    select
    case
