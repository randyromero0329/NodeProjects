...
#TransDB mySQL
sqlcmd -S 10.0.8.34,5598 -U sa  -P ReportSa1108 -d REPV2 << EOF > /home/ubuntu/sales-v1-weekly/GR_REPORTV1-${filename}.txt
...
FROM
    (SELECT RESPONSECODE from REP WHERE RESPONSETIMESTAMP BETWEEN DATEADD(DAY, -7, GETDATE()) AND GETDATE()) t
PIVOT
