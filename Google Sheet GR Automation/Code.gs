...
const v1Headers = ["GR001", "GR002", "GR003", "GR018", "GR033", "GR043", "GR052", "GR152", "FR30", "RM033", "RM041", "FR017", "GR013", "GR049", "GR092", "GR124", "GR069", "FR013", "GR036", "GR055"];

const v3Headers = v1Headers;
const dGateHeaders = ["GR001", "GR003", "GR027", "GR40", "GR056", "RM005"];
const v1FirstCol = 'B';
const v1LastCol = 'U';
const v3FirstCol = 'X';
const v3LastCol = 'AQ';
const dGateFirstCol = 'AT';
const dGateLastCol = 'AY';
