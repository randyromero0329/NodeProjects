...
#TransDB mySQL
sqlcmd -S 10.0.8.34,5598 -U sa  -P ReportSa1108 -d REPV2 << EOF > /home/ubuntu/v1-test/GR_REPORT-GR033${filename}.txt



SELECT TRXTYPE As "TrxType", LEFT(CONCAT(MID_NAME, ' | ' , MID),65) AS "Note: PhilAM Rebill Daily 1:00 AM to 5:00 AM.",
Sum(Case
