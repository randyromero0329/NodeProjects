...
#TransDB postgreSQL
psql -h 10.0.11.5 -p 7766 -d paygate_system_db -U pti_paygate_prod << EOF > /home/ubuntu/v3-test/GR_REPORTV3-${filename}.txt
...
where a.status not in ('GR001','GR002','GR033') AND a.created_at BETWEEN (Now() - interval '1 HOUR') AND now() 
